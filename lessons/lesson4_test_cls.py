...
if __name__ == "__main__":
    ...
    path_y_tag = "/workspace/caffe_dataset_lower_eng/y_tag.json"
    path_model_def = "/workspace/caffe_dataset_lower_eng/lenet.prototxt"
    model_weights = "/workspace/caffe_dataset_lower_eng/lenet_iter_10000.caffemodel"
